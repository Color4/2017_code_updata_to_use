...
def unet_resize(image1,s_size=32):
    ...
    if image1.shape[0] < image1.shape[1]:
        ...
        s0 = s_size
        s1 = int(image1.shape[1] * (float(s_size) / float(image1.shape[0])))
        s1 = s1 - s1 % 64
        _s0 = 16 * s0
        _s1 = int(image1.shape[1] * (float(_s0) / float(image1.shape[0])))
        _s1 = (_s1 + 32) - (_s1 + 32) % 64
    else:
        s1 = s_size
        s0 = int(image1.shape[0] * (float(s_size) / float(image1.shape[1])))
        s0 = s0 - s0 % 64
        _s1 = 16 * s1
        _s0 = int(image1.shape[0] * (float(_s1) / float(image1.shape[1])))
