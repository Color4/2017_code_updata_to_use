...
def bcyTopDownloader(GALLERY_START_URL):
    ...
    all_work = gallery_soup.findAll('li',class_ = '_box')
    top_index = 1
...
if __name__ == '__main__':
    #GALLERY_START_URL = "https://bcy.net/coser/toppost100?type=newPeople"
    GALLERY_START_URL = "https://bcy.net/coser/toppost100?type=lastday"
    # 程序开始的时间
